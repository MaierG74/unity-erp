...
The quote material dialog remains authoritative for which board/edging material is selected and for any customer-facing material surcharge. The costing tree is authoritative for the quote's internal board/edging cost values and profitability. If material selections are changed after costing detail exists, estimators should review the Board materials and Edging groups and adjust quote-only costs as needed.
