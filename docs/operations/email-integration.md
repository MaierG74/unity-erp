...
- **Typed email logs:** `purchase_order_emails.email_type` classifies PO mail as `po_send`, `po_cancel`, `po_line_cancel`, `po_balance_close`, or `po_follow_up`; `supplier_order_id` stores line-level linkage where applicable.
