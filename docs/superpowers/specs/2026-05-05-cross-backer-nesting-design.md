...
status: v4 — post-GPT-5.5-Pro-round-3 (sign-off pending)
date: 2026-05-05
...
review-rounds: round 1 — 1 BLOCKER + 6 MAJORs + 4 MINORs (integrated v2); round 2 — 2 BLOCKERs + 5 MAJORs + 2 MINORs (integrated v3); round 3 — 0 BLOCKERs + 2 MAJORs + 2 MINORs (integrated v4 — stale-wording cleanups only)
---
