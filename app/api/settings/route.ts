...
export async function PUT(req: NextRequest) {
  try {
    ...
    const allowed = ['company_name','company_logo_path','address_line1','address_line2','city','postal_code','country','phone','email','website','vat_number','bank_details','terms_conditions','fg_auto_consume_on_add','po_default_cc_email'];
