  ...
  const createMutation = useMutation({
    ...
    onSuccess: async (result) => {
      await Promise.all([
        ...
        queryClient.invalidateQueries({ queryKey: ['supplier-component-count', supplier.supplier_id] }),
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-5 pt-1">
          <section className="rounded-lg border border-border/50 bg-muted/30 p-4 space-y-4">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Master Item</h3>
            <div className="grid gap-x-4 gap-y-4 md:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-master-code" className="text-xs text-muted-foreground">Master Code</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-unit" className="text-xs text-muted-foreground">Unit</Label>
                <Select
            ...
            <div className="space-y-1.5">
              <Label htmlFor="supplier-item-description" className="text-xs text-muted-foreground">Description</Label>
              <Textarea
            ...
            <div className="grid gap-x-4 gap-y-4 md:grid-cols-3">
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-category" className="text-xs text-muted-foreground">Category</Label>
                <Select
                ...
                >
                  <SelectTrigger id="supplier-item-category">
                    <SelectValue placeholder={lookupsLoading ? 'Loading...' : 'Select category'} />
                  </SelectTrigger>
                  <SelectContent>
                    {categories
              ...
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-qty-on-hand" className="text-xs text-muted-foreground">Qty on Hand</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-reorder-level" className="text-xs text-muted-foreground">Reorder Level</Label>
                <Input
            ...
            <div className="space-y-1.5">
              <Label htmlFor="supplier-item-location" className="text-xs text-muted-foreground">Location</Label>
              <Input
          ...
          <section className="rounded-lg border border-border/50 bg-muted/30 p-4 space-y-4">
            <h3 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Supplier Mapping</h3>
            <div className="grid gap-x-4 gap-y-4 md:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-supplier-code" className="text-xs text-muted-foreground">Supplier Code</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-price" className="text-xs text-muted-foreground">Price</Label>
                <Input
            ...
            <div className="grid gap-x-4 gap-y-4 md:grid-cols-2">
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-lead-time" className="text-xs text-muted-foreground">Lead Time (days)</Label>
                <Input
              ...
              <div className="space-y-1.5">
                <Label htmlFor="supplier-item-moq" className="text-xs text-muted-foreground">Min Order Quantity</Label>
                <Input
