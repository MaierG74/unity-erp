...
import { AlertTriangle, Package, ChevronDown, ChevronRight, Clock, Mail, Loader2 } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
...
export function ReportsOrderingTab() {
  const { user } = useAuth();
                        ...
                        >
                          <TableCell>
                            <Button
                              ...
                              onClick={() => setExpandedComponentId(isExpanded ? null : component.component_id)}
                            >
                              {isExpanded ? (
                        ...
                        <TableRow className="bg-blue-50 hover:bg-blue-100 dark:bg-muted/30 dark:hover:bg-muted/50 dark:border-l-2 dark:border-l-blue-500">
                          <TableCell>
                            <Button
                              ...
                              size="sm"
                              className="h-8 w-8 p-0"
                              onClick={() => setExpandedOnOrderId(isExpanded ? null : component.component_id)}
                            >
                              {isExpanded ? (
                                <ChevronDown className="h-4 w-4" />
                              ) : (
