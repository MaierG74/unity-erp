...
ALTER TABLE public.orders ADD CONSTRAINT orders_completed_from_status_fk
  FOREIGN KEY (completed_from_status_id) REFERENCES public.order_statuses(status_id);
