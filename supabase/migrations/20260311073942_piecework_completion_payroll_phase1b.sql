-- Phase 1b scheduler ownership sync:
-- - ensure first-time scheduling of an issued card also syncs job_cards.staff_id
-- - keep assignment creation atomic with card-owner updates
