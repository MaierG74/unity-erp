-- Supersede component-demand RPCs so extended BOM snapshots use effective fields.
-- Removed swaps serialize effective_quantity_required = 0; old snapshots fall
-- back to component_id / quantity_required via COALESCE.
