...
create index if not exists idx_non_working_days_org_day
  on public.non_working_days (org_id, day_date);

drop trigger if exists non_working_days_set_updated_at on public.non_working_days;
create trigger non_working_days_set_updated_at
before update on public.non_working_days
for each row execute function public.set_current_timestamp();

comment on table public.non_working_days is
  'Payroll-inert non-working-days calendar for absence reporting. Payroll trigger logic reads public.public_holidays, not this table.';
...
begin
  if not exists (
    ...
    where c.conrelid = 'public.staff'::regclass
      and c.conname = 'staff_employment_type_check'
  ) then
    alter table public.staff
      add constraint staff_employment_type_check
      check (employment_type in ('monthly', 'weekly', 'hourly', 'piecework', 'casual'));
  end if;
end $$;

comment on column public.staff.employment_type is
  'Optional employment type used by staff reporting filters. Nullable for staged backfill.';

alter table public.non_working_days enable row level security;

revoke all on table public.non_working_days from anon;
grant select, insert, update, delete on table public.non_working_days to authenticated;
revoke all on sequence public.non_working_days_id_seq from anon;
grant usage, select on sequence public.non_working_days_id_seq to authenticated;

drop policy if exists non_working_days_select_org_member on public.non_working_days;
...
create policy non_working_days_select_org_member
on public.non_working_days
for select
to authenticated
using (public.is_org_member(org_id));

create policy non_working_days_insert_org_admin
on public.non_working_days
for insert
to authenticated
with check (
  ...
  or exists (
    ...
    where m.user_id = auth.uid()
      and m.org_id = non_working_days.org_id
...
create policy non_working_days_update_org_admin
on public.non_working_days
for update
to authenticated
using (
...
create policy non_working_days_delete_org_admin
on public.non_working_days
for delete
to authenticated
using (
...
-- South African statutory public holidays for absence reporting only.
-- Includes Sunday-to-Monday observed holidays for fixed-date public holidays.
-- No Saturday substitute rows are seeded.
insert into public.non_working_days (org_id, day_date, kind, label)
select o.id, v.day_date, v.kind, v.label
from public.organizations o
cross join (values
  ('2025-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2025-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2025-04-18'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2025-04-21'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2025-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2025-04-28'::date, 'observed_holiday'::text, 'Freedom Day (observed)'::text),
  ('2025-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2025-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2025-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2025-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2025-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2025-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2025-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text),

  ('2026-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2026-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2026-04-03'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2026-04-06'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2026-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2026-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2026-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2026-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2026-08-10'::date, 'observed_holiday'::text, 'National Women''s Day (observed)'::text),
  ('2026-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2026-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2026-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2026-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text),

  ('2027-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2027-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2027-03-22'::date, 'observed_holiday'::text, 'Human Rights Day (observed)'::text),
  ('2027-03-26'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2027-03-29'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2027-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2027-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2027-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2027-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2027-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2027-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2027-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2027-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text),
  ('2027-12-27'::date, 'observed_holiday'::text, 'Day of Goodwill (observed)'::text),

  ('2028-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2028-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2028-04-14'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2028-04-17'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2028-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2028-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2028-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2028-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2028-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2028-09-25'::date, 'observed_holiday'::text, 'Heritage Day (observed)'::text),
  ('2028-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2028-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2028-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text),

  ('2029-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2029-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2029-03-30'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2029-04-02'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2029-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2029-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2029-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2029-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2029-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2029-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2029-12-17'::date, 'observed_holiday'::text, 'Day of Reconciliation (observed)'::text),
  ('2029-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2029-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text),

  ('2030-01-01'::date, 'public_holiday'::text, 'New Year''s Day'::text),
  ('2030-03-21'::date, 'public_holiday'::text, 'Human Rights Day'::text),
  ('2030-04-19'::date, 'public_holiday'::text, 'Good Friday'::text),
  ('2030-04-22'::date, 'public_holiday'::text, 'Family Day'::text),
  ('2030-04-27'::date, 'public_holiday'::text, 'Freedom Day'::text),
  ('2030-05-01'::date, 'public_holiday'::text, 'Workers'' Day'::text),
  ('2030-06-16'::date, 'public_holiday'::text, 'Youth Day'::text),
  ('2030-06-17'::date, 'observed_holiday'::text, 'Youth Day (observed)'::text),
  ('2030-08-09'::date, 'public_holiday'::text, 'National Women''s Day'::text),
  ('2030-09-24'::date, 'public_holiday'::text, 'Heritage Day'::text),
  ('2030-12-16'::date, 'public_holiday'::text, 'Day of Reconciliation'::text),
  ('2030-12-25'::date, 'public_holiday'::text, 'Christmas Day'::text),
  ('2030-12-26'::date, 'public_holiday'::text, 'Day of Goodwill'::text)
) as v(day_date, kind, label)
on conflict (org_id, day_date) do nothing;

create or replace function public.staff_absence_report(
  p_start date,
  p_end date,
...
comment on function public.staff_absence_report(date, date, int[], text, text) is
  'Absence report RPC. Reads public.non_working_days, not public.public_holidays, so seeded absence-report holidays remain payroll-inert.';
