-- Migration: Harden receiving over-receipt guard
-- Date: February 24, 2026
-- Description: Add server-side over-receipt guard to process_supplier_order_receipt.
-- Computes net received (receipts - returns) BEFORE inserting and rejects if
-- p_quantity exceeds remaining. Closes the "Harden receiving validation" TODO.
...
begin
  ...
  -- Over-receipt guard: compute net received BEFORE this receipt
...
GRANT EXECUTE ON FUNCTION public.process_supplier_order_receipt(integer, integer, timestamptz) TO authenticated;
GRANT EXECUTE ON FUNCTION public.process_supplier_order_receipt(integer, integer, timestamptz) TO service_role;
