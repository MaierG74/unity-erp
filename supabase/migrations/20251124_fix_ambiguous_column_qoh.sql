...
-- Update process_supplier_order_receipt to fix ambiguous column reference for quantity_on_hand
-- Fully qualifying column names to avoid conflicts with output parameters
