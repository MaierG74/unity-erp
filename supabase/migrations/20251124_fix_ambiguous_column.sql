...
-- Update process_supplier_order_receipt to fix ambiguous column reference
-- Renaming variables to avoid conflict with column names
...
begin
  ...
  returning transaction_type_id into v_purch_type_id;
