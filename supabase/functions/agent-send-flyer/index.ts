        ...
        <tr>
          <td style="padding:20px 20px 12px;">
            <a href="${flyerUrl}" target="_blank" style="display:block;text-decoration:none;">
              <img src="${flyerUrl}" alt="${productName}" width="560" style="width:100%;max-width:560px;border-radius:4px;display:block;" />
            </a>
          </td>
        </tr>
        <tr>
          <td style="padding:0 20px 16px;text-align:center;">
            <p style="font-size:11px;color:#a0a0a0;margin:0;">Click the image to view full size</p>
          </td>
        </tr>
      </table>
    </td></tr>
